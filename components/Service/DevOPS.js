                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-md-6">
                            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                ...
                                <div className="col-auto d-flex align-items-center justify-content-center">
                                    <img src={cicd} width="200" height="250" alt="" />
                        ...
                        <div className="col-md-6">
                            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                ...
                                <div className="col-auto d-flex align-items-center justify-content-center">
                                    <img className="bd-placeholder-Image" width="200" height="250" src="https://cdn.pixabay.com/photo/2020/08/07/05/45/cloud-5469737_640.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
                        ...
                        <div className="col-md-6">
                            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                ...
                                <div className="col-auto d-flex align-items-center justify-content-center">
                                    <img className="bd-placeholder-Image" width="200" height="250" src="https://cdn.pixabay.com/photo/2023/06/30/07/55/internet-8097838_640.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
