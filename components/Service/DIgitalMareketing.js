    ...
    <div>
      <div id="carouselExampleCaptions" className="carousel slide">
                <div className="carousel-inner">
                    ...
                    <img style={{ height:"500px" ,width:"100vw" }} src={"https://cdn.pixabay.com/photo/2024/03/13/07/41/digital-marketing-8630397_640.png"} className="d-block w-100" alt="" layout="responsive"  />
                    </div>
                </div>
            </div>
                ...
                <div className="row mb-2">
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                ...
                                <h3 className="mb-0">Digital Marketing Strategy and Planning</h3>
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img className="bd-placeholder-Image" width="200" height="250"
                                    src="https://cdn.pixabay.com/photo/2016/03/09/13/58/online-marketing-1246457_640.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img src="https://cdn.pixabay.com/photo/2016/11/19/21/01/analysis-1841158_640.jpg" width="200" height="250"alt="" />
                    ...
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                ...
                                <h3 className="mb-0">Social Media Marketing</h3>
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img className="bd-placeholder-Image" width="200" height="250"
                                    src="https://cdn.pixabay.com/photo/2016/11/03/18/19/social-media-1795578_640.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                ...
                                <h3 className="mb-0">Pay-Per-Click (PPC) Advertising</h3>
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img width="200" height="250" src="https://cdn.pixabay.com/photo/2019/09/09/08/23/internet-4463031_640.jpg" alt="" />
                    ...
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img className="bd-placeholder-Image" width="200" height="250" src="https://cdn.pixabay.com/photo/2020/07/01/19/49/email-marketing-5360758_640.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                ...
                                <h3 className="mb-0">Conversion Rate Optimization (CRO)</h3>
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img width="200" height="250" src="https://cdn.pixabay.com/photo/2023/11/25/08/16/ai-generated-8411278_640.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                <h3 className="mb-0">Affiliate Marketing</h3>
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img className="bd-placeholder-Image" width="200" height="250" src="https://cdn.pixabay.com/photo/2022/04/21/09/58/affiliate-marketing-7147115_640.png" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                ...
                                <h3 className="mb-0">Influencer Marketing</h3>
                               
                                <p className="mb-auto">Web designing is the process of planning, conceptualizing, and implementing the plan for designing a website in a way that is functional and offers a good user experience. User experience is central to the web designing process.</p>
                           
                            </div>
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img width="200" height="250" src="https://cdn.pixabay.com/photo/2019/04/29/07/04/success-4165306_640.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
