...
import design from '../../public/Assests/Image/Design.png'
    ...
    return (
      ...
      <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner">
                    ...
                    <Image src={design} height={50} width={100}  className="d-block w-100" alt="" layout="responsive"  />
                    {/* </div> */}
                </div>
            </div>
                ...
                <div className="row mb-2">
                    ...
                    <div className="col-md-6">
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            ...
                            <div className="col-auto d-flex align-items-center justify-content-center">
                                <img className="bd-placeholder-Image" width="200" height="250" src="https://cdn.pixabay.com/photo/2015/07/17/22/43/student-849825_640.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
